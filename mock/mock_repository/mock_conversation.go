...
//
//	mockgen -source=conversation.go -destination=../../mock/mock_repository/mock_conversation.go -package=mock_repository
//
...
func (mr *MockConversationMockRecorder) GetStatus(arg0, arg1 any) *gomock.Call {
...
func (mr *MockConversationMockRecorder) SetStatus(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
